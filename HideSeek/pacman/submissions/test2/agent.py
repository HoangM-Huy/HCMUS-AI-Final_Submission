...
class PacmanAgent(BasePacmanAgent):
    ...
    def step(self, map_state: np.ndarray,
        ...
        self.dist_map = self._precompute_distances(enemy_position, map_state)
    ...
    def _precompute_distances(self, goal, map_state):
        ...
        # Initialize with a high value (like 100 or float('inf'))
        distances = np.full((rows, cols), 100)
